...
const AuthRequiredModal = dynamic(
  () => import("./_components/AuthRequiredModal")
);
const DepositModal = dynamic(() => import("./_components/DepositModal"));
const ExpandedMediaModal = dynamic(
  () => import("./_components/ExpandedMediaModal")
);
const ProviderProfileModal = dynamic(
  () => import("./_components/ProviderProfileModal")
);
const PurchaseModal = dynamic(() => import("./_components/PurchaseModal"));
const ReportModal = dynamic(() => import("./_components/ReportModal"));

export type PrestadoresPageProps = {
  initialCity?: string;
