...
export const generateMetadata = (props: CityPageProps) =>
  generateProviderCityMetadata("masajistas", props);

export default function MasajistasCityPage(props: CityPageProps) {
  return <ProviderCitySearchPage routeKey="masajistas" {...props} />;
}
